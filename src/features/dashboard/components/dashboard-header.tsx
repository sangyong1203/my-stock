...
export function DashboardHeader({ model }: Props) {
  ...
  return (
    <div>
      <header className="relative overflow-visible rounded-3xl border border-border/70 bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 p-6 text-zinc-50 shadow-sm">
          ...
          >
            <div className="min-h-0 overflow-hidden">
              <div className="overflow-x-auto pb-1">
                <div className="flex min-w-max items-stretch gap-4">{summaryModules}</div>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute inset-x-0 -bottom-2.5 flex justify-center">
          <Button
            ...
            className="h-[10px] w-20 rounded-b-full rounded-t-none border border-t-0 border-border/60 bg-zinc-900/95 p-0 text-zinc-300 shadow-none hover:bg-border/60 hover:text-white"
